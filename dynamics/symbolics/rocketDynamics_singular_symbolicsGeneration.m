...
stateDerivative = subs(stateDerivative, thrust, Tsingular);

% Creat Symbolic File for Equations of Motion
matlabFunction(stateDerivative, Tsingular, S, Sdot, Hamiltonian, 'file', 'rocketDynamics_singular', 'Optimize', true, 'vars', {epoch, [x;lam], thrust, effectiveExhaustVelocity, rho}); 
